--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_LNB_DAYM_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_LNB_DAYM_INS" (P_FECHA_DESDE IN CHAR)
IS
-- Autor: Paula Fernandez. Fecha: 16.09.2015.
...
CURSOR CUR (FECHA_DESDE VARCHAR2, FECHA_HASTA VARCHAR2) IS
  ...
  LEFT OUTER JOIN LTE_NSN_SERVICE_NE_DAYM T2
