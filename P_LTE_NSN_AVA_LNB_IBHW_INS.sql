--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_LNB_IBHW_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_LNB_IBHW_INS" (P_FECHA_DESDE IN CHAR)
IS
...
TYPE T_ARRAY_TAB IS TABLE OF LTE_NSN_AVAIL_NE_IBHW%ROWTYPE;
...
FROM LTE_NSN_AVAIL_LCEL_IBHW T1
LEFT OUTER JOIN LTE_NSN_AVAIL_NE_IBHW T2
  ...
  LOOP
    ...
    BEGIN
      FORALL I IN 1 .. T_ARRAY_COL.COUNT SAVE EXCEPTIONS
        INSERT INTO LTE_NSN_AVAIL_NE_IBHW VALUES T_ARRAY_COL (I);
    EXCEPTION
