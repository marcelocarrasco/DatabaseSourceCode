--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_LCE_INS_DAILY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_LCE_INS_DAILY" (P_FECHA_DESDE     IN CHAR,
...
-- Actualizacion: Mariano Moron. Fecha: 09.09.2015. Motivo: Estandarización de nombres.
-- Actualizacion: Mariano Moron. Fecha: 16.09.2015. Motivo: Se agrega procesamiento de BH Service.
