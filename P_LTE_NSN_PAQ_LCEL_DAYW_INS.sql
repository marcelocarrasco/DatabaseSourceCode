--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_LCEL_DAYW_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_LCEL_DAYW_INS" (P_FECHA_DESDE IN CHAR)
IS
-- Autor: Paula Fernandez Fecha: 04.09.2015.
-- Actualizacion: Paula Fernandez Fecha: 14.09.2015. Motivo: Se agregan parametros de entrada.
...
TYPE T_ARRAY_TAB IS TABLE OF LTE_NSN_PAQ_LCEL_DAYW%ROWTYPE;
...
SELECT
    ...
    FROM LTE_NSN_PAQ_LCEL_DAY T1
        LEFT OUTER JOIN LTE_NSN_PAQ_LCEL_DAYW T2
  ...
  LOOP
    ...
    BEGIN
      FORALL I IN 1 .. T_ARRAY_COL.COUNT SAVE EXCEPTIONS
        INSERT INTO LTE_NSN_PAQ_LCEL_DAYW VALUES T_ARRAY_COL (I);
    EXCEPTION
