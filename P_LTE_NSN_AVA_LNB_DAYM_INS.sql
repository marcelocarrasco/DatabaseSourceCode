--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_LNB_DAYM_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_LNB_DAYM_INS" (P_FECHA_DESDE IN CHAR)
IS
...
TYPE T_ARRAY_TAB IS TABLE OF LTE_NSN_AVAIL_NE_DAYM%ROWTYPE;
...
CURSOR CUR (FECHA_DESDE VARCHAR2, FECHA_HASTA VARCHAR2) IS
    ...
    FROM LTE_NSN_AVAIL_LCEL_DAY T1
      LEFT OUTER JOIN LTE_NSN_AVAIL_NE_DAYW T2
  ...
  LOOP
    ...
    BEGIN
      FORALL I IN 1 .. T_ARRAY_COL.COUNT SAVE EXCEPTIONS
        INSERT INTO LTE_NSN_AVAIL_NE_DAYM VALUES T_ARRAY_COL (I);
    EXCEPTION
