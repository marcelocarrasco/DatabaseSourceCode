--------------------------------------------------------
--  DDL for View FLNS_3051A_CONS_ISABHWEEK
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."FLNS_3051A_CONS_ISABHWEEK" ("FECHA", "PERIOD_DURATION", "FINS_ID", "MME_NAME", "COMP_AVERAGE_LOAD", "COMP_PEAK_LOAD_PERCENT") AS 
