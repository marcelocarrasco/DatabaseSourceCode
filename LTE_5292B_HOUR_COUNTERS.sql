--------------------------------------------------------
--  DDL for View LTE_5292B_HOUR_COUNTERS
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."LTE_5292B_HOUR_COUNTERS" ("PERIOD_START_TIME", "CO_NAME", "PDCP_DATA_RATE_MEAN_DL") AS 
  SELECT TO_DATE(SUBSTR( TO_CHAR( PERIOD_START_TIME, 'DD/MM/RRRR HH24:MI'), 0, 13),'DD/MM/YYYY HH24:MI') AS PERIOD_START_TIME, CO_NAME,
		SUM(PDCP_DATA_RATE_MEAN_DL) AS PDCP_DATA_RATE_MEAN_DL
