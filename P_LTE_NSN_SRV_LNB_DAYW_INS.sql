--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_LNB_DAYW_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_LNB_DAYW_INS" (P_FECHA_DESDE IN CHAR)
IS
...
LEFT OUTER JOIN LTE_NSN_SERVICE_NE_DAYW T2
