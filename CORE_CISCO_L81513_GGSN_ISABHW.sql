--------------------------------------------------------
--  DDL for View CORE_CISCO_L81513_GGSN_ISABHW
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L81513_GGSN_ISABHW" ("FECHA", "GWNAME", "SERVID", "SERVNAME", "DOWNLINK_THP_MBPS_GBR") AS 
  SELECT TRUNC(hist.FECHA , 'DAY') AS FECHA, hist.GWNAME, hist.SERVID, hist.SERVNAME, ROUND(AVG(hist.DOWNLINK_THP_MBPS_GBR),2 ) AS DOWNLINK_THP_MBPS_GBR
FROM(
