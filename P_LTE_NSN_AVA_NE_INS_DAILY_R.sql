--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_NE_INS_DAILY_R
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_NE_INS_DAILY_R" (P_FECHA_DESDE     IN CHAR,
  ...
  FOR SEN IN PERIODO (P_FECHA_DESDE, P_FECHA_HASTA) LOOP
    ...
    FOR SYN IN ELEMENTOS LOOP
      ...
      IF P_LEVEL = 'DAY' THEN
        ...
        ELSE
            P_LTE_NSN_AVA_NE_DAY_INS (SYN.NE, SEN.FECHA, SEN.FECHA);
        END IF;
      ...
      ELSIF P_LEVEL = 'BH' THEN
        ...
        ELSE
            P_LTE_NSN_AVA_NE_BH_INS (SYN.NE, SEN.FECHA, SEN.FECHA);
        END IF;
