--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_LNB_DAY_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_LNB_DAY_INS" (P_FECHA_DESDE IN CHAR, P_FECHA_HASTA IN CHAR)
IS
...
LEFT OUTER JOIN LTE_NSN_PAQ_NE_DAY T2
ON TO_CHAR(T1.LNBTS_ID) = T2.ELEMENT_ID
AND T1.FECHA = T2.FECHA
WHERE T1.FECHA BETWEEN TO_DATE(FECHA_DESDE, 'DD.MM.YYYY') AND TO_DATE(FECHA_HASTA, 'DD.MM.YYYY')
