--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_NE_INS_WEEKLY_R
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_NE_INS_WEEKLY_R" (P_FECHA_DESDE     IN CHAR,
  ...
  FOR SEN IN PERIODO (P_FECHA_DESDE, P_FECHA_HASTA) LOOP
    ...
    FOR SYN IN ELEMENTOS LOOP
      ...
      IF P_LEVEL = 'DAYW' THEN
        ...
        ELSE
            P_LTE_NSN_SRV_NE_DAYW_INS (SYN.NE, SEN.FECHA_CHR);
        END IF;
      ...
      ELSIF P_LEVEL = 'IBHW' THEN
        ...
        ELSE
            P_LTE_NSN_SRV_NE_IBHW_INS (SYN.NE, SEN.FECHA_CHR);
        END IF;
