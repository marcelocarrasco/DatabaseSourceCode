--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_LCE_JOB_WEEKLY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_LCE_JOB_WEEKLY" 
IS
...
P_SUBCLASS_TABLE VARCHAR2(10) := 'LCE';
 ...
 P_LTE_NSN_AVA_LCE_INS_WEEKLY(P_FECHA_DESDE, P_FECHA_HASTA, P_SUBCLASS_TABLE, 'DAYW');

 P_LTE_NSN_AVA_LCE_INS_WEEKLY(P_FECHA_DESDE, P_FECHA_HASTA, P_SUBCLASS_TABLE, 'IBHW');
