--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_NE_IBHW_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_NE_IBHW_INS" (P_ELE_CLASS IN CHAR, P_FECHA_DESDE IN CHAR)
IS
...
TYPE T_ARRAY_TAB IS TABLE OF LTE_NSN_PAQ_NE_IBHW%ROWTYPE;
  ...
  LOOP
    ...
    BEGIN
      FORALL I IN 1 .. T_ARRAY_COL.COUNT SAVE EXCEPTIONS
        INSERT INTO LTE_NSN_PAQ_NE_IBHW VALUES T_ARRAY_COL (I);
    EXCEPTION
