--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_NE_INS_DAILY_R
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_NE_INS_DAILY_R" (P_FECHA_DESDE     IN CHAR,
                                                          P_FECHA_HASTA     IN CHAR,
                                                          P_LEVEL           IN CHAR,
                                                          P_RESULT OUT NUMBER) IS


-- Autor: Mariano Morón. Fecha: 07.10.2015.
  ...
  FOR SEN IN PERIODO (P_FECHA_DESDE, P_FECHA_HASTA) LOOP
    ...
    FOR SYN IN ELEMENTOS LOOP
      ...
      IF P_LEVEL = 'DAY' THEN
        ...
        ELSE
            P_LTE_NSN_SRV_NE_DAY_INS (SYN.NE, SEN.FECHA, SEN.FECHA);
        END IF;
      ...
      ELSIF P_LEVEL = 'BH' THEN
        ...
        ELSE
            P_LTE_NSN_SRV_NE_BH_INS (SYN.NE, SEN.FECHA, SEN.FECHA);
        END IF;
