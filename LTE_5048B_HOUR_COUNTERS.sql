--------------------------------------------------------
--  DDL for View LTE_5048B_HOUR_COUNTERS
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."LTE_5048B_HOUR_COUNTERS" ("PERIOD_START_TIME", "CO_NAME", "SUCC_INTER_ENB_HO", "ATT_INTER_ENB_HO") AS 
