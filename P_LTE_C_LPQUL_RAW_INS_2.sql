--------------------------------------------------------
--  DDL for Procedure P_LTE_C_LPQUL_RAW_INS_2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_C_LPQUL_RAW_INS_2" (
...
p_ossrc IN VARCHAR2) IS
  ...
  p_source1_table  CONSTANT VARCHAR2(150):= 'NOKLTE_PS_LPQUL_MNC1_VW';
  p_target_table  CONSTANT VARCHAR2(150):= 'NOKLTE_PS_LPQUL_MNC1_RAW';
