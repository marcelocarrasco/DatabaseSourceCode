--------------------------------------------------------
--  DDL for View CORE_CISCO_L81802_GGSN_BH
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L81802_GGSN_BH" ("FECHA", "GWNAME", "DIAMETER_CC_UPDATE_SUCC_R") AS 
  SELECT hist.FECHA, hist.GWNAME, hist.DIAMETER_CC_UPDATE_SUCC_R
FROM (
