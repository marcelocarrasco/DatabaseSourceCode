--------------------------------------------------------
--  DDL for View CORE_CISCO_L81802_GGSN_ISABHM
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L81802_GGSN_ISABHM" ("FECHA", "GWNAME", "DIAMETER_CC_UPDATE_SUCC_R") AS 
  SELECT TRUNC(hist.FECHA , 'MONTH') AS FECHA, hist.GWNAME, ROUND(AVG(hist.DIAMETER_CC_UPDATE_SUCC_R),2 ) AS DIAMETER_CC_UPDATE_SUCC_R
FROM(
