--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_LNB_DAY_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_LNB_DAY_INS" (P_FECHA_DESDE IN CHAR, P_FECHA_HASTA IN CHAR)
IS
...
LEFT OUTER JOIN LTE_NSN_AVAIL_NE_DAY T2
