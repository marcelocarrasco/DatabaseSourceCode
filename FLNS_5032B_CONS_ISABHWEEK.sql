--------------------------------------------------------
--  DDL for View FLNS_5032B_CONS_ISABHWEEK
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."FLNS_5032B_CONS_ISABHWEEK" ("FECHA", "PERIOD_DURATION", "FINS_ID", "MME_NAME", "FLNS_5029B") AS 
  SELECT TRUNC(hist.FECHA, 'DAY') AS FECHA,
       hist.PERIOD_DURATION,
       hist.FINS_ID,
       hist.MME_NAME,
       ROUND(AVG(hist.FLNS_5032B), 2) AS FLNS_5029B
