--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_LCEL_INS_DAILY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_LCEL_INS_DAILY" (P_FECHA_DESDE     IN CHAR,
...
-- Actualizacion: Paula Fernandez. Fecha: 09.09.2015. Motivo: Estandarizacion de nombres.
-- Actualizacion: Mariano Moron. Fecha: 16.09.2015. Motivo: Se agrega procesamiento de BH Power and Quality.
