--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_LCE_DAYW_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_LCE_DAYW_INS" (P_FECHA_DESDE IN CHAR)
IS
-- Autor: Mariano Moron. Fecha: 02.09.2015.
...
TYPE T_ARRAY_TAB IS TABLE OF LTE_NSN_SERVICE_LCEL_DAYW%ROWTYPE;
...
SELECT
    ...
    NVL(AVG(T1.USER_ACT_BUFFER_UL_AVG)                     ,0 )  AS  USER_ACT_BUFFER_UL_AVG,
    NVL(AVG(T1.USER_ACT_BUFFER_DL_AVG)                      ,0 )  AS  USER_ACT_BUFFER_DL_AVG,
  ...
  FROM LTE_NSN_SERVICE_LCEL_DAY T1
  LEFT OUTER JOIN LTE_NSN_SERVICE_LCEL_DAYW T2
  ...
  LOOP
    ...
    BEGIN
      FORALL I IN 1 .. T_ARRAY_COL.COUNT SAVE EXCEPTIONS
        INSERT INTO LTE_NSN_SERVICE_LCEL_DAYW VALUES T_ARRAY_COL (I);
    EXCEPTION
