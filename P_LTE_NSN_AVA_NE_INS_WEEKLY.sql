--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_NE_INS_WEEKLY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_NE_INS_WEEKLY" (P_FECHA_DESDE     IN CHAR,
...
IF V_TABLA_A_TRUNCAR IS NOT NULL THEN
  ...
  FOR SEN IN PERIODO (P_FECHA_DESDE, P_FECHA_HASTA, V_CANTIDAD_SEMANAS) LOOP
    ...
    IF P_LEVEL = 'DAYW' THEN
      ...
      ELSE
          P_LTE_NSN_AVA_NE_DAYW_INS (P_SUBCLASS_TABLE, SEN.FECHA_CHR);
      END IF;
    ...
    ELSIF P_LEVEL = 'IBHW' THEN
      ...
      ELSE
          P_LTE_NSN_AVA_NE_IBHW_INS (P_SUBCLASS_TABLE, SEN.FECHA_CHR);
      END IF;
