--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_LNB_IBHW_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_LNB_IBHW_INS" (P_FECHA_DESDE IN CHAR)
IS
...
FROM LTE_NSN_PAQ_LCEL_IBHW T1
LEFT OUTER JOIN LTE_NSN_PAQ_NE_IBHW T2
