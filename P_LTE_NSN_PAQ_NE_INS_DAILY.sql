--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_NE_INS_DAILY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_NE_INS_DAILY" (P_FECHA_DESDE     IN CHAR,
...
IF V_TABLA_A_TRUNCAR IS NOT NULL THEN
  ...
  FOR SEN IN PERIODO (P_FECHA_DESDE, P_FECHA_HASTA, V_CANTIDAD_SEMANAS) LOOP
    ...
    IF P_LEVEL = 'DAY' THEN
      ...
      ELSE
          P_LTE_NSN_PAQ_NE_DAY_INS (P_SUBCLASS_TABLE, SEN.FECHA, SEN.FECHA);
      END IF;
    ...
    ELSIF P_LEVEL = 'BH' THEN
      ...
      ELSE
          P_LTE_NSN_PAQ_NE_BH_INS (P_SUBCLASS_TABLE, SEN.FECHA, SEN.FECHA);
      END IF;
