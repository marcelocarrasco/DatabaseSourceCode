--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_LCE_INS_HOURLY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_LCE_INS_HOURLY" (P_FECHA_DESDE     IN CHAR,
...
IF V_TABLA_A_TRUNCAR IS NOT NULL THEN
  ...
  P_LTE_TRUNCATE_SPART_HOURLY (P_FECHA_DESDE, P_FECHA_HASTA, V_TABLA_A_TRUNCAR, P_SUBCLASS_TABLE);
    ...
    P_LTE_NSN_SRV_LCE_HOUR_INS (P_FECHA_DESDE, P_FECHA_HASTA);
