--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_SRV_LCE_JOB_HOURLY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_SRV_LCE_JOB_HOURLY" 
IS
...
P_SUBCLASS_TABLE VARCHAR2(10) := 'LCE';
 ...
 P_LTE_NSN_SRV_LCE_INS_HOURLY(P_FECHA_DESDE, P_FECHA_HASTA, P_SUBCLASS_TABLE, 'HOUR');
