--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_NE_INS_MONTH_R
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_NE_INS_MONTH_R" (P_FECHA_DESDE     IN CHAR,
  ...
  FOR SEN IN PERIODO (P_FECHA_DESDE, P_FECHA_HASTA) LOOP
    ...
    FOR SYN IN ELEMENTOS LOOP
      ...
      IF P_LEVEL = 'DAYM' THEN
        ...
        ELSE
            P_LTE_NSN_PAQ_NE_DAYM_INS (SYN.NE, SEN.FECHA_CHR);
        END IF;
      ...
      ELSIF P_LEVEL = 'IBHM' THEN
        ...
        ELSE
            P_LTE_NSN_PAQ_NE_IBHM_INS (SYN.NE, SEN.FECHA_CHR);
        END IF;
