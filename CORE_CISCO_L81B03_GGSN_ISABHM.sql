--------------------------------------------------------
--  DDL for View CORE_CISCO_L81B03_GGSN_ISABHM
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L81B03_GGSN_ISABHM" ("FECHA", "GWNAME", "SERVID", "SERVNAME", "DPCA_CCA_MESSAGES_ACCEPTED") AS 
  SELECT TRUNC(hist.FECHA , 'MONTH') AS FECHA, hist.GWNAME, hist.SERVID, hist.SERVNAME, ROUND(AVG(hist.DPCA_CCA_MESSAGES_ACCEPTED),2 ) AS DPCA_CCA_MESSAGES_ACCEPTED
FROM(
