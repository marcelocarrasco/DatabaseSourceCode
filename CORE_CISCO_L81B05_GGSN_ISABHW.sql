--------------------------------------------------------
--  DDL for View CORE_CISCO_L81B05_GGSN_ISABHW
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L81B05_GGSN_ISABHW" ("FECHA", "GWNAME", "SERVID", "SERVNAME", "DPCA_NUM_OF_CCAI_TIMEOUTS") AS 
  SELECT TRUNC(hist.FECHA , 'DAY') AS FECHA, hist.GWNAME, hist.SERVID, hist.SERVNAME, ROUND(AVG(hist.DPCA_NUM_OF_CCAI_TIMEOUTS),2 ) AS DPCA_NUM_OF_CCAI_TIMEOUTS
FROM(
