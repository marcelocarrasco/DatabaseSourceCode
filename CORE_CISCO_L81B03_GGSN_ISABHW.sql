--------------------------------------------------------
--  DDL for View CORE_CISCO_L81B03_GGSN_ISABHW
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L81B03_GGSN_ISABHW" ("FECHA", "GWNAME", "SERVID", "SERVNAME", "DPCA_CCA_MESSAGES_ACCEPTED") AS 
  SELECT TRUNC(hist.FECHA , 'DAY') AS FECHA, hist.GWNAME, hist.SERVID, hist.SERVNAME, ROUND(AVG(hist.DPCA_CCA_MESSAGES_ACCEPTED),2 ) AS DPCA_CCA_MESSAGES_ACCEPTED
FROM(
