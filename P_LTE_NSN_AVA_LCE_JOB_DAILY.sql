--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_LCE_JOB_DAILY
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_LCE_JOB_DAILY" 
IS
...
P_SUBCLASS_TABLE VARCHAR2(10) := 'LCE';
 ...
 P_LTE_NSN_AVA_LCE_INS_DAILY(P_FECHA_DESDE, P_FECHA_HASTA, P_SUBCLASS_TABLE, 'DAY');

 P_LTE_NSN_AVA_LCE_INS_DAILY(P_FECHA_DESDE, P_FECHA_HASTA, P_SUBCLASS_TABLE, 'BH');
