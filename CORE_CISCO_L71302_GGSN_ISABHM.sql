--------------------------------------------------------
--  DDL for View CORE_CISCO_L71302_GGSN_ISABHM
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L71302_GGSN_ISABHM" ("FECHA", "GWNAME", "SERVID", "SERVNAME", "DOWNLINK_THROUGHPUT") AS 
  SELECT TRUNC(hist.FECHA , 'MONTH') AS FECHA, hist.GWNAME, hist.SERVID, hist.SERVNAME, ROUND(AVG(hist.DOWNLINK_THROUGHPUT),2 ) AS DOWNLINK_THROUGHPUT
FROM(
