--------------------------------------------------------
--  DDL for View PRINCIP_COUNTERS_DAY
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."PRINCIP_COUNTERS_DAY" ("FECHA", "CO_NAME", "INT_ID", "M8013C6", "M8013C7", "M8013C8", "M8013C27", "M8006C2", "M8006C4", "M8006C3", "M8006C5", "M8006C12", "M8006C14", "M8006C13") AS 
...
GROUP BY  TO_DATE( SUBSTR( FECHA, 0, 10), 'DD/MM/RRRR'), INT_ID, CO_NAME
;
