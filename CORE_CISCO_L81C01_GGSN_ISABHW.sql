--------------------------------------------------------
--  DDL for View CORE_CISCO_L81C01_GGSN_ISABHW
--------------------------------------------------------

  CREATE OR REPLACE VIEW "HARRIAGUE"."CORE_CISCO_L81C01_GGSN_ISABHW" ("FECHA", "GWNAME", "PGW_LICENSING") AS 
  SELECT TRUNC(hist.FECHA , 'DAY') AS FECHA, hist.GWNAME, ROUND(AVG(hist.PGW_LICENSING),2 ) AS PGW_LICENSING
FROM(
