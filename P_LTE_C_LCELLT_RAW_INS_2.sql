--------------------------------------------------------
--  DDL for Procedure P_LTE_C_LCELLT_RAW_INS_2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_C_LCELLT_RAW_INS_2" (
...
p_ossrc IN VARCHAR2) IS
 ...
 /* dml_errors EXCEPTION;
  ...
  p_source1_table  CONSTANT VARCHAR2(150):= 'NOKLTE_PS_LCELLT_MNC1_VW';
  p_target_table  CONSTANT VARCHAR2(150):= 'NOKLTE_PS_LCELLT_MNC1_RAW';
