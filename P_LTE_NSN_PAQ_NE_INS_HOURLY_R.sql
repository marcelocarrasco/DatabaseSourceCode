--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_PAQ_NE_INS_HOURLY_R
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_PAQ_NE_INS_HOURLY_R" (P_FECHA_DESDE     IN CHAR,
    ...
    FOR SYN IN ELEMENTOS LOOP
      ...
      IF P_LEVEL = 'HOUR' THEN
        ...
        IF SYN.NE = 'LNBTS' THEN
            P_LTE_NSN_PAQ_LNB_HOUR_INS (SEN.FECHA_DESDE, SEN.FECHA_HASTA);
            commit;
        ELSE
            P_LTE_NSN_PAQ_NE_HOUR_INS (SYN.NE, SEN.FECHA_DESDE, SEN.FECHA_HASTA);
            commit;
        END IF;
