--------------------------------------------------------
--  DDL for Procedure P_LTE_NSN_AVA_LNB_BH_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_NSN_AVA_LNB_BH_INS" (P_FECHA_DESDE IN CHAR, P_FECHA_HASTA IN CHAR)
IS
...
LEFT OUTER JOIN LTE_NSN_AVAIL_NE_BH T2
