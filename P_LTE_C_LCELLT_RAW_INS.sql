--------------------------------------------------------
--  DDL for Procedure P_LTE_C_LCELLT_RAW_INS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "HARRIAGUE"."P_LTE_C_LCELLT_RAW_INS" (P_FECHA_DESDE IN CHAR, P_FECHA_HASTA IN CHAR)
IS
...
SELECT T1.*
FROM NOKLTE_PS_LCELLT_MNC1_RAW@OSSRC2.WORLD T1
LEFT OUTER JOIN NOKLTE_PS_LCELLT_MNC1_RAW T3
